...
## h1 - Hello World 
Ansible ja Micro teksti editorin asennus. Ansible konfigurointiin tein kansioita ja tekstitiedostoja Micro:lla (kiva tekstieditori en ole ennen käyttänyt. ps. kivempi ku nano :p). Testasin Ansible uptime komennon avulla. Tein QoL muutoksia pystyn lyhentämään uptime komentoa, kätevää.
